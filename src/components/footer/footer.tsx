      ...
      <ContainerAnimated client:visible>
        <div class="my-3">
          ...
          <div class="flex flex-col md:flex-row items-center gap-2">
            ...
            <div
              class="border border-white bg-white h-14 w-14 md:h-16 md:w-16 rounded-full flex justify-center items-center text-black cursor-pointer"
          ...
          <div class="flex items-center justify-center my-14 gap-8">
